...
testObj = findTestObject('AI-Generated/Page_home/button_add_to_cart_sauce_labs_backpack')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Successful Login and Add Item to Cart in Checkout Step One_visual_checkpoint')
